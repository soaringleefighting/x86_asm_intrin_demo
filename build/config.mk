...
ifeq ($(platform), wasm_32)
	...
	ARCH_DEF	:= -DARCH_X86=1 -DARCH_ARM=0 -DARCH_AARCH64=0 -DARCH_MIPS=0 
	arch		:= x86
	#ASM			:= emcc -DPIC -DUSE_EMCC
	EXTRA_CFLAGS := -m32 $(ARCH_DEF) -DUSE_EMCC -msimd128 -msse -msse2 -mssse3
...
ifeq ($(platform), wasm_64)
	...
	ARCH_DEF	:= -DARCH_X86=1 -DARCH_ARM=0 -DARCH_AARCH64=0 -DARCH_MIPS=0 -DARCH_X86_64=1 
	arch		:= x86
	#ASM			:= yasm -DPIC -DUSE_EMCC
	EXTRA_CFLAGS := -m64 $(ARCH_DEF) -DUSE_EMCC -msimd128 -msse -msse2 -msse3 -mssse3 -msse4.1
...
###X86_32架构	
ifeq ($(platform), x86_32)
EXTRA_CFLAGS+= -DARCH_X86_64=0 -msse -msse2 -msse3 -mssse3 -msse4.1
EXTRA_AFLAGS:= -m x86 -DHAVE_ALIGNED_STACK=1 -DARCH_X86_64=0 -DHAVE_CPUNOP=0 -f elf32  $(ARCH_DEF)
endif

###X86_64架构	
ifeq ($(platform), x86_64)
EXTRA_CFLAGS += -DARCH_X86_64=1 -msse -msse2 -msse3 -mssse3 -msse4.1
EXTRA_AFLAGS := -m amd64 -DARCH_X86_64=1 -DSTACK_ALIGNMENT=32  -DHAVE_CPUNOP=0 -DHAVE_ALIGNED_STACK=1 -DHIGH_BIT_DEPTH=0 -DBIT_DEPTH=8 -f elf64 $(ARCH_DEF)
endif

###ARM32架构	
ifeq ($(platform), arm32)
EXTRA_CFLAGS += -DHAVE_NEON=1
endif
